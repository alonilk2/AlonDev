...
function App() {
  ...
  const renderPages = () => {
    switch(pageScrollState){
      case 0: 
          return (
                  <section class="content custom-animation-white">
        <div class="content-body">
          <h1 className= "content-title delay-1">Software Engineer</h1>
          <h1 className="content-title-2 full-stack custom-animation-gradient delay-2">Full-Stack</h1>
          <h1 className="content-title-2 developer custom-animation-white delay-1"> Developer</h1>
        </div>
      </section>
        )
        break;
      case 1: 
          return (
                  <section class="content animation-horizontal">
        <div class="content-body">
          <h1 className= "content-title custom-animation-white delay-1">Software Engineer</h1>
          <h1 className="content-title-2 full-stack custom-animation-gradient delay-2">Full-Stack</h1>
          <h1 className="content-title-2 developer custom-animation-white delay-1"> Developer</h1>
        </div>
      </section>
